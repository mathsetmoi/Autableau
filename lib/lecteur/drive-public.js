// ============================================================
// UN DOSSIER PUBLIC DU DRIVE, LU SANS COMPTE
// ============================================================
// Les séances publiées vivent dans un dossier du Drive partagé « à tout
// utilisateur disposant du lien ». Un tel dossier se lit avec une simple clé
// d'API Google, sans que l'élève ait de compte ni que rien ne s'ouvre : on
// demande la liste des fichiers du dossier, puis le fichier lui-même.
//
...
// à la fenêtre de publication, qui vérifie que Drive Desktop a bien envoyé
// le fichier.
// ============================================================
(function () {
    'use strict';
    ...
    function expliquer(e) {
        ...
        if (code === 403) return 'Google refuse : la clé est-elle restreinte à un autre site, ou le dossier n\'est-il pas partagé « à tout utilisateur disposant du lien » ?';
        if (code === 404) return 'Dossier introuvable : est-il bien partagé « à tout utilisateur disposant du lien », et l\'identifiant est-il celui du dossier ?';
    ...
    async function telecharger(id, cle) {
    ...
    window.DrivePublic = { reglages, idDepuisLeLien, expliquer, lister, trouver, telecharger, lireLaSeance };
})();
