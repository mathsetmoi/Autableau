...
//
// La séance vient d'un dossier public du Drive (lib/lecteur/drive-public.js),
...
(function () {
    ...
    const enLecteur = params.has('lecteur') || params.has('f') || params.has('u') || params.has('seance');
