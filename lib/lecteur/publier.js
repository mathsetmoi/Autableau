...
(function () {
    ...
    function preparerBrouillon() {
        ...
        if (ui.brouillon && ui.brouillon.coupes.length) dire('Le tableau a changé : un nouveau montage commence.');
    ...
    function rendrePublier(p) {
        ...
        p.appendChild(h('div', { class: 'pw-bloc pub-montage-resume' },
            h('div', {}, h('div', { class: 'pw-bloc-titre' }, 'Le replay à publier'),
                h('p', { class: 'pub-texte', id: 'pub-montage-resume' }, stats.retirees
                    ? stats.retirees + ' étape(s) retirée(s). Les élèves verront le montage.'
                    : 'Vous pouvez retirer des passages et prévisualiser la séance.')),
