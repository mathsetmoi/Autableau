...
window.AUTABLEAU_PUBLICATION = {
    dossier: '',    // l'identifiant du dossier partagé (la fin de son lien de partage)
    cle: '',        // la clé d'API Google, restreinte à ce site
    adresse: ''     // l'adresse publique du site, si elle n'est pas celle où l'on est
};
