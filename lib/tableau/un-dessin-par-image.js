...
(function () {
    ...
    function unDessinParImage(horodatage) {
        ...
        compte.dessins++;
        // Par la propriété, et non par la fermeture : un test ou un outil de
        // mesure peut ainsi poser une sonde sur « draw.origine » et voir
        // passer chaque dessin réel.
        return unDessinParImage.origine.apply(this, arguments);
    }
