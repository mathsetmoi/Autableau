...
(function () {
    ...
    // LA SÉANCE PUBLIÉE POUR LES ÉLÈVES. Le module lib/lecteur/publier.js
    // pose son bouton ici : le dossier public vit dans CE Drive, c'est donc
    // au bas de ce panneau qu'on le trouve.
    function publierEnBas(boite) {
        if (window.Publication && typeof Publication.poserDansLeTiroir === 'function') {
            Publication.poserDansLeTiroir(boite);
        }
    }
    ...
    document.addEventListener('DOMContentLoaded', () => {
        // LE LECTEUR D'UNE SÉANCE PUBLIÉE N'EST PAS UNE SÉANCE DE TRAVAIL.
        // Le professeur qui ouvre son propre lien a, lui, ses dossiers et
        // parfois le droit d'y écrire encore : reprendre son tableau de la
        // veille remplacerait la séance qu'il est venu regarder. On ne
        // reprend donc rien — le drapeau est posé par lib/lecteur/lecteur.js
        // au chargement, avant que ceci ne tourne.
    ...
    window.MonDossier = {
        ...
        // Ce dont la publication des séances a besoin : où écrire, et quoi.
        racine: () => etat.racine,
        dossierAu, contenuDuTableau, nomCourant, nomDeFichierSur,
